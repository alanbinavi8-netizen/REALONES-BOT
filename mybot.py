...
if not TOKEN:
    TOKEN = 'MTQ4NTc0Mzk2OTMxNTg0ODIzOQ.GR_Rvw.qhYuw9TB_ymMgSp5k1kgosB3X2Xg5SXkNdoSac'
...
for i in range(1, 201):
    ...
    zikr_list.append("اللَّهُمَّ اغْفِرْ لِي وَتُبْ عَلَيَّ إِنَّكَ أَنْتَ التَّوَّابُ الرَّحِيمُ")
    zikr_list.append("لَا إِلَهَ إِلَّا اللَّهُ وَحْدَهُ لَا شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ، وَهُوَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ")
    zikr_list.append("اللَّهُمَّ اغْفِرْ لِلْمُؤْمِنِينَ وَالْمُؤْمِنَاتِ وَالْمُسْلِمِينَ وَالْمُسْلِمَاتِ الْأَحْيَاءِ مِنْهُمْ وَالْأَمْوَاتِ")
    zikr_list.append("أَسْتَغْفِرُ اللَّهَ وَأَتُوبُ إِلَيْهِ")
    zikr_list.append("لَا حَوْلَ وَلَا قُوَّةَ إِلَّا بِاللَّه")
    zikr_list.append("اللَّهُمَّ اغْفِرْ لِي وَتُبْ عَلَيَّ إِنَّكَ أَنْتَ التَّوَّابُ الرَّحِيمُ")
    zikr_list.append("رَبِّ اغْفِرْ وَارْحَمْ وَأَنْتَ خَيْرُ الرَّاحِمِينَ")
    zikr_list.append("لَا إِلَهَ إِلَّا اللَّهُ الْعَظِيمُ الْحَلِيمُ")
    zikr_list.append("اللَّهُمَّ أَعِنِّي عَلَى ذِكْرِكَ وַشُكْرِكָ وַحُسْنِ عِبَادَتِك")
    zikr_list.append("رَبِّ اشْرَحْ لِي صَدْرِي وَيَسِّرْ لِي أَمْرِي")
    zikr_list.append("اللَّهُمَّ أَجِرْنِي مِنَ النَّارِ")
    zikr_list.append("لَا إِلَهَ إِلَّا اللَّهُ")
    zikr_list.append("اللَّهُمَّ اغْفِرْ لِي")
    zikr_list.append("أَسْتَغْفِرُ اللَّهَ")
    zikr_list.append("اللَّهُ أَكْبَرُ")
    zikr_list.append("سُبْحَانَ اللَّهِ")
    zikr_list.append("سُبْحَانَ اللَّهِ وَبِحَمْدِهِ")                      
    zikr_list.append("سُبْحَانَ اللَّهِ الْعَظِيمِ")
    zikr_list.append("لَا إِلَهَ إِلَّا اللَّهُ وَحْدَهُ لَا شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ، وَهُوَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ")
    zikr_list.append("يَا حَيُّ يَا قَيُّومُ بِرَحْمَتِكَ أَسْتَغِيثُ، أَصْلِحْ لِي شَأْنِي كُلَّهُ وَلَا تَكِلْنِي إِلَى نَفْسِي طَرْفَةَ عَيْنٍ")
    zikr_list.append("اللَّهُمَّ اغْفِرْ لِي وَتُبْ عَلَيَّ إِنَّكَ أَنْتَ التَّوَّابُ الرَّحِيمُ")
    zikr_list.append("رَبِّ اغْفِرْ وَارْحَمْ وَأَنْتَ خَيْرُ الرَّاحِمِينَ")
    zikr_list.append("لَا إِلَهَ إِلَّا اللَّهُ الْعَظِيمُ الْحَلِيمُ")
    zikr_list.append("اللَّهُمَّ أَعِنِّي عَلَى ذِكْرِكَ وַشُكْرِكָ וַحُسْنِ عِبَادَتِك")
    zikr_list.append("رَبِّ اشْرَحْ لِي صَدْرِي وَيَسِّرْ لِي أًمْرِي")
    zikr_list.append("Yَا مُقَلِّبَ الْقُلُوبِ ثَبِّتْ قَلْبِي عَلَى دِينِكَ")
    zikr_list.append("رَبِّ اشْرَحْ لِي صَدْرِي وَيَسِّرْ لِي أَمْرِي")
    zikr_list.append("بِسْمِ اللَّهِ الَّذِي لَا يَضُرُّ مَعَ اسْمِهِ شَيْءٌ فِي الْأَرْضِ وَلَا فِي السَّمَاءِ وَهُوَ السَّمِيعُ الْعَلِيمُ")
    zikr_list.append("حَسْبُنَا اللَّهُ وَنِعْمَ الْوَكِيلُ")
    zikr_list.append("رَبِّ اشْرَحْ لِي صَدْرِي وَيَسِّرْ لِي أَمْرِي")
    zikr_list.append("تَوَفَّنِي مُسْلِمًا وَأَلْحِقْنِي بِالصَّالِحِينَ")                               
